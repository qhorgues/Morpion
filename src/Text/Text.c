 ...
 */
void loadText(SDL_Window* window, SDL_Renderer* renderer, const char * text, TTF_Font * font, Text* text_ptr, const SDL_Color colorText, const int Quality, const SDL_Color* background) { // Charger le texte en memoire
 ...
 */
void printText(SDL_Window* window, SDL_Renderer* renderer, Text* text, const int x, const int y) { // Afficher le texte
