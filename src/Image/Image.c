 ...
 * 
 */
void printImage(SDL_Window* window, SDL_Renderer* renderer, IMG * image, const unsigned short x, const unsigned short y, const unsigned short w, const unsigned short h) { // Afficher l'image sur le rendue
